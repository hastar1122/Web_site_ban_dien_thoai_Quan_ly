    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="" method="post" id="form-client-register" client-register-url="{{URL::to('/register')}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder=" " name="account" id="account" required="">
                    </div>
                    <div class="form-group">
                    ...
                    <input id="role" name="role" type="number" value="4" class="form-control form-control-user" hidden>
                </form>
            </div>
        </div>
    </div>
