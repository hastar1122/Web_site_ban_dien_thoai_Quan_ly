<div class="modal fade" id="modal-user-edit">
    <div class="modal-dialog modal-dialog-centered modal-xl modal-dialog-scrollable">
        <div class="modal-content">
            <form action="" data-url="" id="form-user-add" method="POST" role="form">
                @csrf
                <!-- Modal Header -->
                <div class="modal-header">
                    <h4 class="modal-title text-info">Cập nhật tài khoản</h4>
                        ...
                        <div class="col-md-8">
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md">
                                            <input type="text" name="user_name" id="user-name-edit" type="text"
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="col-md">
                                        <select name="user_role" id="user-role-edit" class="form-control"
                                            onmousedown="if(this.options.length>4){this.size=4;}"
                                            onchange='this.size=0;' onblur="this.size=0;" required>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="col-md">
                                        <input type="email" name="user_email" id="user-email-edit" type="text"
                                 ...
                                 <div class="form-group col-md-6">
                                    ...
                                    <div class="col-md">
                                        <input type="tel" name="user_phone" id="user-phone-edit" tpattern="[0-9]"
                                            class="form-control form-control-user">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="col-md">
                                        <input type="text" name="user_address" id="user-address-edit" type="text"
                                            class="form-control form-control-user">
                                    </div>
                                </div>
                            </div>
